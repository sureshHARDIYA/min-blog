      ...
      {!hasChosen ? (
        ...
        >
          <p className="text-sm leading-6 text-white/75">
            This site uses optional Google Analytics to understand which pages are useful. Analytics loads only if
            you accept. Read the <a className="text-[#00FF41] underline underline-offset-4" href="/privacy">privacy notice</a>.
          </p>
