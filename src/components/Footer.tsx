...
export const Footer: React.FC<FooterProps> = () => {
  ...
  return (
    <footer
      className={`w-full mt-auto border-t relative z-10 transition-colors duration-300 ${
        theme === 'light'
    ...
    >
      <Stagger
        gap={0.12}
        className='grid grid-cols-1 md:grid-cols-5 gap-6 px-6 py-10 max-w-[1120px] mx-auto items-start'
      >
        <StaggerItem className='col-span-1 md:col-span-2 space-y-3'>
          <span
            className={`font-black text-sm tracking-widest block uppercase ${
        ...
        <StaggerItem className='col-span-1 md:col-span-2'>
          <span
            className={`font-code text-[10px] uppercase tracking-[0.2em] block mb-3 font-bold ${
          ...
          <nav className='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-2 font-body-md text-xs'>
            ...
            <a
              href='https://skm-presents.netlify.app/?slideIndex=0&stepIndex=0'
              target='_blank'
              rel='noopener noreferrer'
              className={`transition-colors duration-200 inline-flex items-center gap-1 font-mono ${
                theme === 'light'
            ...
            >
              <span>{t.footer.myTalks}</span>
              <span className='material-symbols-outlined text-xs'>
                north_east
              </span>
            </a>
            <a
              href='https://github.com/sureshHARDIYA/phd-resources'
              target='_blank'
              rel='noopener noreferrer'
              className={`transition-colors duration-200 inline-flex items-center gap-1 font-mono ${
                theme === 'light'
